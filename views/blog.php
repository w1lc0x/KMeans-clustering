    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-lg-12 text-center">
                    <img class="img-responsive img-border img-full" src="https://www.standardmedia.co.ke/images/sunday/paj2stc0kdcxgp74s593d87f6d9fe0.jpg" alt="">
                    <h2>Construction of a 15 Million Bridge 
                        <br>
                        <small>April 3, 2017</small>
                    </h2>
                    <p>The government will spend Sh15 million on the reconstruction of Sikubale bridge, which connects Kakamega and Bungoma counties.
                     Work has started, according to Navakholo MP Emmanuel Wangwe when he officially launched the construction at the weekend. A lorry that was transporting molasses plunged into the river when the bridge collapsed earlier this year. Four people were killed.</p>
                    <a href=" https://www.standardmedia.co.ke/business/article/2001243119/government-commences-construction-of-sh-15-million-bungoma-bridge" class="btn btn-default btn-lg">Read More</a>
                    <hr>
                </div>
                <div class="col-lg-12 text-center">
